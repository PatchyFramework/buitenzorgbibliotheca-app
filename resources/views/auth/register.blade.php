    ...
    <div class="w-screen h-screen flex items-center justify-center">
        ...
        <div class="w-full h-full flex items-center justify-center">
            <div class="flex flex-col flex-1 items-center justify-center m-5">
                <img src="{{ asset('img/nobg.png') }}" alt="Logo" class="max-w-[10rem] lg:max-w-[10rem]">



                <div class="w-full max-w-md p-6 bg-white drop-shadow-lg rounded-lg">
                    <form action="{{ route('register.post')}}" method="post" enctype="multipart/form-data" class="space-y-3">
                        @csrf
                        <div>
                            <label for="username" class="block text-lg font-bold text-solidorange">Username</label>
                            <input type="username" name="username" id="username" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-tealblue peer" placeholder="Masukkan Username atau Username...." required>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-solidorange peer" placeholder="Masukkan Email...." required>
                        </div>
                        <div>
                            <label for="namalengkap" class="block text-lg font-bold text-tealblue">Nama Lengkap</label>
                            <input type="namalengkap" name="namalengkap" id="namalengkap" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-solidorange peer" placeholder="Masukkan Nama Lengkap...." required>
                        </div>
                        <div>
                            <label for="alamat" class="block text-lg font-bold text-tealblue">Alamat</label>
                            <textarea name="alamat" id="alamat" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-solidorange peer" placeholder="Masukkan Alamat...." required>
                            </textarea>
                        </div>
                        ...
                        <button type="submit" class="w-full block text-white bg-yellowjabar hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2 text-center">
                            Register
                        </button>
                    </form>
                    ...
                    <a href="{{ route('registeradmin') }}" class="block text-white bg-bluejabar hover:bg-darkbluejabar focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2 text-center">
        ...
        <div class="hidden lg:block lg:w-[90%] lg:h-[98%] lg:relative lg:m-auto">
